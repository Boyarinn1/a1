...
# ------------------------------------------------------------
# 5) Основная логика (поиск и публикация) - ИЗМЕНЕНА
# ------------------------------------------------------------
async def main():
    """
    ...
    """
    print("\n" + "="*50)
    print("🚀 Запуск скрипта публикации B2 -> Telegram (v7: Пропуск неполных + переход к следующему)") # <-- Обновлено название
    print("="*50)
